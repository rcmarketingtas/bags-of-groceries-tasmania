    ...
    <div className="min-h-screen py-16">
      <div className="mx-auto max-w-2xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-6 flex items-start gap-3 rounded-xl border border-white/10 bg-white/5 p-4">
          <Shield className="mt-0.5 h-5 w-5 shrink-0 text-[#3d6b51]" />
          <div className="text-sm text-muted-foreground">
            <strong className="text-white">Your privacy matters.</strong> The
            information you provide is used only to assess your application and
